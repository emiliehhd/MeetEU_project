...
def regression(val_smiles, train_smiles, train_val, k=10):
    ...
    val_smiles : list of smile of ligand that we want to predict 
    train_smiles : list of smile of ligand that we use to train
    train_val : feature of train_smiles
    k : number of top distance for each val_smiles
    """
